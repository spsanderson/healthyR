...
![](reference/figures/README-gartner_chart-1.png)
...
- [`ts_signature_tbl()`](https://www.spsanderson.com/healthyR/reference/ts_signature_tbl.md) -
  Add time-based features to your data
...
- [`ts_median_excess_plt()`](https://www.spsanderson.com/healthyR/reference/ts_median_excess_plt.md) -
  Identify excess utilization patterns
...
Guidelines](https://www.spsanderson.com/healthyR/CODE_OF_CONDUCT.md) for
details on:
