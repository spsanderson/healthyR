...
To view the full wiki, click here: [Full healthyR Wiki](https://github.com/spsanderson/healthyR/blob/master/wiki/README.md)
...
Create quadrant charts for performance analysis (e.g., comparing length of stay vs readmission risk):
...
Automatically classify patients into service lines based on clinical codes:

```{r service_line, eval=FALSE}
...
- [📚 Function Reference](https://www.spsanderson.com/healthyR/reference/index.html) - Complete documentation of all functions
- [🚀 Getting Started Vignette](https://www.spsanderson.com/healthyR/articles/getting-started.html) - Detailed introduction and tutorials
- [📰 News & Changelog](https://www.spsanderson.com/healthyR/news/index.html) - Latest updates and changes

## Data Included

healthyR includes reference datasets for service line classification:

- `dx_cc_mapping` - ICD-10 diagnosis code mappings for condition categories
- `px_cc_mapping` - ICD-10 procedure code mappings for procedure categories

## Contributing

We welcome contributions! Please see our [Contributing Guidelines](CODE_OF_CONDUCT.md) for details on:
...
1. Check the [function documentation](https://www.spsanderson.com/healthyR/reference/index.html)
2. Review the [Getting Started vignette](https://www.spsanderson.com/healthyR/articles/getting-started.html)
